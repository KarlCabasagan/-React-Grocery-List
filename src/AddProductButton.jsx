...
function AddProductButton() {
    ...
    return(
        <div className=" fixed bottom-8 right-6 z-10 rounded-xl shadow-lg">
            <button onClick={() => setAddProductModal(!addProductModal)} className="w-14 h-14 bg-red-700 flex justify-center items-center rounded-xl">
