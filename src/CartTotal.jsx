    ...
    return(
        <div className="w-full h-24 bg-zinc-50 border-t-2 border-zinc-300 flex gap-0 justify-between items-center sticky shadow-md">
            <div className="w-[75%] ml-4">
                ...
                <h1 className="text-2xl text-red-600 font-semibold ml-2">₱{total.toFixed(2)}</h1>
            </div>
            <div className="w-[25%] h-full bg-red-600 flex justify-center items-center">
                <button onClick={handlePurchase} className="w-full h-full flex justify-center items-center">
